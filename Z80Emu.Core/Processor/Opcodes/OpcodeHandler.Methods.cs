...
public partial class OpcodeHandler
{
    private void InitializeMethods()
    {
        ...
        _opcodes["DD BIT 0,(IX+d)"].Execute = () => { BIT(0, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["DD BIT 1,(IX+d)"].Execute = () => { BIT(1, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["DD BIT 2,(IX+d)"].Execute = () => { BIT(2, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["DD BIT 3,(IX+d)"].Execute = () => { BIT(3, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["DD BIT 4,(IX+d)"].Execute = () => { BIT(4, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["DD BIT 5,(IX+d)"].Execute = () => { BIT(5, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["DD BIT 6,(IX+d)"].Execute = () => { BIT(6, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["DD BIT 7,(IX+d)"].Execute = () => { BIT(7, _mmu[_reg.IX + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 0,(IY+d)"].Execute = () => { BIT(0, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 1,(IY+d)"].Execute = () => { BIT(1, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 2,(IY+d)"].Execute = () => { BIT(2, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 3,(IY+d)"].Execute = () => { BIT(3, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 4,(IY+d)"].Execute = () => { BIT(4, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 5,(IY+d)"].Execute = () => { BIT(5, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 6,(IY+d)"].Execute = () => { BIT(6, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        _opcodes["FD BIT 7,(IY+d)"].Execute = () => { BIT(7, _mmu[_reg.IY + (sbyte)NextByte()]); NextByte(); };
        ...
        _opcodes["0D DEC C"].Execute = () => { _reg.C = DEC(_reg.C); };
        _opcodes["15 DEC D"].Execute = () => { _reg.D = DEC(_reg.D); };
        _opcodes["1D DEC E"].Execute = () => { _reg.E = DEC(_reg.E); };
        ...
        _opcodes["ED IN D,(C)"].Execute = () => _reg.D = _ports[_reg.C];
        _opcodes["ED IN E,(C)"].Execute = () => _reg.E = _ports[_reg.C];
        _opcodes["ED IN H,(C)"].Execute = () => _reg.H = _ports[_reg.C];
        _opcodes["ED IN L,(C)"].Execute = () => _reg.L = _ports[_reg.C];
        _opcodes["ED IN A,(C)"].Execute = () => _reg.A = _ports[_reg.C];
        ...
        _opcodes["0C INC C"].Execute = () => { _reg.C = INC(_reg.C); };
        _opcodes["14 INC D"].Execute = () => { _reg.D = INC(_reg.D); };
        _opcodes["1C INC E"].Execute = () => { _reg.E = INC(_reg.E); };
        _opcodes["24 INC H"].Execute = () => { _reg.H = INC(_reg.H); };
        _opcodes["2C INC L"].Execute = () => { _reg.L = INC(_reg.L); };
        _opcodes["3C INC A"].Execute = () => { _reg.A = INC(_reg.A); };
        _opcodes["ED IND"].Execute = () => IND();
        ...
        _opcodes["5E LD E,(HL)"].Execute = () => _reg.E = _mmu[_reg.HL];
        _opcodes["66 LD H,(HL)"].Execute = () => _reg.H = _mmu[_reg.HL];
        _opcodes["6E LD L,(HL)"].Execute = () => _reg.L = _mmu[_reg.HL];
        _opcodes["7E LD A,(HL)"].Execute = () => _reg.A = _mmu[_reg.HL];
        ...
        _opcodes["0E LD C,n"].Execute = () => _reg.C = NextByte();
        _opcodes["16 LD D,n"].Execute = () => _reg.D = NextByte();
        _opcodes["1E LD E,n"].Execute = () => _reg.E = NextByte();
        _opcodes["26 LD H,n"].Execute = () => _reg.H = NextByte();
        _opcodes["2E LD L,n"].Execute = () => _reg.L = NextByte();
        _opcodes["3E LD A,n"].Execute = () => _reg.A = NextByte();
        ...
        _opcodes["ED LDD"].Execute = () => LDD();
        _opcodes["ED LDDR"].Execute = () => LDDR();
        _opcodes["ED LDI"].Execute = () => LDI();
        _opcodes["ED LDIR"].Execute = () => LDIR();
        _opcodes["ED NEG"].Execute = () => NEG();
        ...
        _opcodes["ED OTDR"].Execute = () => OTDR();
        _opcodes["ED OTIR"].Execute = () => OTIR();
        _opcodes["ED OUT (C),B"].Execute = () => _ports[_reg.C] = _reg.B;
        _opcodes["ED OUT (C),C"].Execute = () => _ports[_reg.C] = _reg.C;
        _opcodes["ED OUT (C),D"].Execute = () => _ports[_reg.C] = _reg.D;
        _opcodes["ED OUT (C),E"].Execute = () => _ports[_reg.C] = _reg.E;
        _opcodes["ED OUT (C),H"].Execute = () => _ports[_reg.C] = _reg.H;
        _opcodes["ED OUT (C),L"].Execute = () => _ports[_reg.C] = _reg.L;
        _opcodes["ED OUT (C),A"].Execute = () => _ports[_reg.C] = _reg.A;
        _opcodes["D3 OUT (n),A"].Execute = () => _ports[NextByte()] = _reg.A;
        _opcodes["ED OUTD"].Execute = () => OUTD();
        _opcodes["ED OUTI"].Execute = () => OUTI();
        ...
        {
            _mmu[--_reg.SP] = _reg.IX.Msb();
            _mmu[--_reg.SP] = _reg.IX.Lsb();
        };
        _opcodes["FD PUSH IY"].Execute = () =>
        {
            _mmu[--_reg.SP] = _reg.IY.Msb();
            _mmu[--_reg.SP] = _reg.IY.Lsb();
        };
        _opcodes["CB RES 0,(HL)"].Execute = () => { _mmu[_reg.HL] = RES(0, _mmu[_reg.HL]); };
        _opcodes["CB RES 1,(HL)"].Execute = () => { _mmu[_reg.HL] = RES(1, _mmu[_reg.HL]); };
        ...
        _opcodes["DD RES 0,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(0, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD RES 1,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(1, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD RES 2,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(2, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD RES 3,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(3, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD RES 4,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(4, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD RES 5,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(5, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD RES 6,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(6, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD RES 7,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = RES(7, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["FD RES 0,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(0, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD RES 1,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(1, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD RES 2,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(2, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD RES 3,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(3, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD RES 4,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(4, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD RES 5,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(5, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD RES 6,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(6, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD RES 7,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = RES(7, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["CB RES 0,B"].Execute = () => { _reg.B = RES(0, _reg.B); };
        _opcodes["CB RES 1,B"].Execute = () => { _reg.B = RES(1, _reg.B); };
        _opcodes["CB RES 2,B"].Execute = () => { _reg.B = RES(2, _reg.B); };
        _opcodes["CB RES 3,B"].Execute = () => { _reg.B = RES(3, _reg.B); };
        _opcodes["CB RES 4,B"].Execute = () => { _reg.B = RES(4, _reg.B); };
        _opcodes["CB RES 5,B"].Execute = () => { _reg.B = RES(5, _reg.B); };
        _opcodes["CB RES 6,B"].Execute = () => { _reg.B = RES(6, _reg.B); };
        _opcodes["CB RES 7,B"].Execute = () => { _reg.B = RES(7, _reg.B); };
        ...
        _opcodes["DD SET 0,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(0, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD SET 1,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(1, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD SET 2,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(2, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD SET 3,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(3, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD SET 4,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(4, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD SET 5,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(5, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD SET 6,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(6, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["DD SET 7,(IX+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IX + d] = SET(7, _mmu[_reg.IX + d]); NextByte(); };
        _opcodes["FD SET 0,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(0, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD SET 1,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(1, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD SET 2,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(2, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD SET 3,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(3, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD SET 4,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(4, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD SET 5,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(5, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD SET 6,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(6, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["FD SET 7,(IY+d)"].Execute = () => { var d = (sbyte)NextByte(); _mmu[_reg.IY + d] = SET(7, _mmu[_reg.IY + d]); NextByte(); };
        _opcodes["CB SET 0,B"].Execute = () => { _reg.B = SET(0, _reg.B); };
        _opcodes["CB SET 1,B"].Execute = () => { _reg.B = SET(1, _reg.B); };
        _opcodes["CB SET 2,B"].Execute = () => { _reg.B = SET(2, _reg.B); };
        _opcodes["CB SET 3,B"].Execute = () => { _reg.B = SET(3, _reg.B); };
        _opcodes["CB SET 4,B"].Execute = () => { _reg.B = SET(4, _reg.B); };
        _opcodes["CB SET 5,B"].Execute = () => { _reg.B = SET(5, _reg.B); };
        _opcodes["CB SET 6,B"].Execute = () => { _reg.B = SET(6, _reg.B); };
        _opcodes["CB SET 7,B"].Execute = () => { _reg.B = SET(7, _reg.B); };
        _opcodes["CB SET 0,C"].Execute = () => { _reg.C = SET(0, _reg.C); };
        _opcodes["CB SET 1,C"].Execute = () => { _reg.C = SET(1, _reg.C); };
        _opcodes["CB SET 2,C"].Execute = () => { _reg.C = SET(2, _reg.C); };
        _opcodes["CB SET 3,C"].Execute = () => { _reg.C = SET(3, _reg.C); };
        _opcodes["CB SET 4,C"].Execute = () => { _reg.C = SET(4, _reg.C); };
        _opcodes["CB SET 5,C"].Execute = () => { _reg.C = SET(5, _reg.C); };
        _opcodes["CB SET 6,C"].Execute = () => { _reg.C = SET(6, _reg.C); };
        _opcodes["CB SET 7,C"].Execute = () => { _reg.C = SET(7, _reg.C); };
        _opcodes["CB SET 0,D"].Execute = () => { _reg.D = SET(0, _reg.D); };
        _opcodes["CB SET 1,D"].Execute = () => { _reg.D = SET(1, _reg.D); };
        _opcodes["CB SET 2,D"].Execute = () => { _reg.D = SET(2, _reg.D); };
        _opcodes["CB SET 3,D"].Execute = () => { _reg.D = SET(3, _reg.D); };
        _opcodes["CB SET 4,D"].Execute = () => { _reg.D = SET(4, _reg.D); };
        _opcodes["CB SET 5,D"].Execute = () => { _reg.D = SET(5, _reg.D); };
        _opcodes["CB SET 6,D"].Execute = () => { _reg.D = SET(6, _reg.D); };
        _opcodes["CB SET 7,D"].Execute = () => { _reg.D = SET(7, _reg.D); };
        _opcodes["CB SET 0,E"].Execute = () => { _reg.E = SET(0, _reg.E); };
        _opcodes["CB SET 1,E"].Execute = () => { _reg.E = SET(1, _reg.E); };
        _opcodes["CB SET 2,E"].Execute = () => { _reg.E = SET(2, _reg.E); };
        _opcodes["CB SET 3,E"].Execute = () => { _reg.E = SET(3, _reg.E); };
        _opcodes["CB SET 4,E"].Execute = () => { _reg.E = SET(4, _reg.E); };
        _opcodes["CB SET 5,E"].Execute = () => { _reg.E = SET(5, _reg.E); };
        _opcodes["CB SET 6,E"].Execute = () => { _reg.E = SET(6, _reg.E); };
        _opcodes["CB SET 7,E"].Execute = () => { _reg.E = SET(7, _reg.E); };
        _opcodes["CB SET 0,H"].Execute = () => { _reg.H = SET(0, _reg.H); };
        _opcodes["CB SET 1,H"].Execute = () => { _reg.H = SET(1, _reg.H); };
        _opcodes["CB SET 2,H"].Execute = () => { _reg.H = SET(2, _reg.H); };
        _opcodes["CB SET 3,H"].Execute = () => { _reg.H = SET(3, _reg.H); };
        _opcodes["CB SET 4,H"].Execute = () => { _reg.H = SET(4, _reg.H); };
        _opcodes["CB SET 5,H"].Execute = () => { _reg.H = SET(5, _reg.H); };
        _opcodes["CB SET 6,H"].Execute = () => { _reg.H = SET(6, _reg.H); };
        _opcodes["CB SET 7,H"].Execute = () => { _reg.H = SET(7, _reg.H); };
        _opcodes["CB SET 0,L"].Execute = () => { _reg.L = SET(0, _reg.L); };
        _opcodes["CB SET 1,L"].Execute = () => { _reg.L = SET(1, _reg.L); };
        _opcodes["CB SET 2,L"].Execute = () => { _reg.L = SET(2, _reg.L); };
        _opcodes["CB SET 3,L"].Execute = () => { _reg.L = SET(3, _reg.L); };
        _opcodes["CB SET 4,L"].Execute = () => { _reg.L = SET(4, _reg.L); };
        _opcodes["CB SET 5,L"].Execute = () => { _reg.L = SET(5, _reg.L); };
        _opcodes["CB SET 6,L"].Execute = () => { _reg.L = SET(6, _reg.L); };
        _opcodes["CB SET 7,L"].Execute = () => { _reg.L = SET(7, _reg.L); };
        _opcodes["CB SET 0,A"].Execute = () => { _reg.A = SET(0, _reg.A); };
        _opcodes["CB SET 1,A"].Execute = () => { _reg.A = SET(1, _reg.A); };
        _opcodes["CB SET 2,A"].Execute = () => { _reg.A = SET(2, _reg.A); };
        _opcodes["CB SET 3,A"].Execute = () => { _reg.A = SET(3, _reg.A); };
        _opcodes["CB SET 4,A"].Execute = () => { _reg.A = SET(4, _reg.A); };
        _opcodes["CB SET 5,A"].Execute = () => { _reg.A = SET(5, _reg.A); };
        _opcodes["CB SET 6,A"].Execute = () => { _reg.A = SET(6, _reg.A); };
        _opcodes["CB SET 7,A"].Execute = () => { _reg.A = SET(7, _reg.A); };
