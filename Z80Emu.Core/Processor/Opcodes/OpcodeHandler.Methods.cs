...
public partial class OpcodeHandler
{
    private void InitializeMethods()
    {
        ...
        _opcodes["DD ADC A,(IX+d)"].Execute = () => { };
        _opcodes["FD ADC A,(IY+d)"].Execute = () => { };
        ...
        _opcodes["ED ADC HL,BC"].Execute = () => { };
        _opcodes["ED ADC HL,DE"].Execute = () => { };
        _opcodes["ED ADC HL,HL"].Execute = () => { };
        _opcodes["ED ADC HL,SP"].Execute = () => { };
        _opcodes["86 ADD A,(HL)"].Execute = () => { ADD(_mmu[_reg.HL]); };
        _opcodes["DD ADD A,(IX+d)"].Execute = () => { };
        _opcodes["FD ADD A,(IY+d)"].Execute = () => { };
        ...
        _opcodes["DD ADD IX,BC"].Execute = () => { };
        _opcodes["DD ADD IX,DE"].Execute = () => { };
        _opcodes["DD ADD IX,IX"].Execute = () => { };
        _opcodes["DD ADD IX,SP"].Execute = () => { };
        _opcodes["FD ADD IY,BC"].Execute = () => { };
        _opcodes["FD ADD IY,DE"].Execute = () => { };
        _opcodes["FD ADD IY,IY"].Execute = () => { };
        _opcodes["FD ADD IY,SP"].Execute = () => { };
        _opcodes["A6 AND (HL)"].Execute = () => { AND(_mmu[_reg.HL]); };
        _opcodes["DD AND (IX+d)"].Execute = () => { };
        _opcodes["FD AND (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD BIT 0,(IX+d)"].Execute = () => { };
        _opcodes["DD BIT 1,(IX+d)"].Execute = () => { };
        _opcodes["DD BIT 2,(IX+d)"].Execute = () => { };
        _opcodes["DD BIT 3,(IX+d)"].Execute = () => { };
        _opcodes["DD BIT 4,(IX+d)"].Execute = () => { };
        _opcodes["DD BIT 5,(IX+d)"].Execute = () => { };
        _opcodes["DD BIT 6,(IX+d)"].Execute = () => { };
        _opcodes["DD BIT 7,(IX+d)"].Execute = () => { };
        _opcodes["FD BIT 0,(IY+d)"].Execute = () => { };
        _opcodes["FD BIT 1,(IY+d)"].Execute = () => { };
        _opcodes["FD BIT 2,(IY+d)"].Execute = () => { };
        _opcodes["FD BIT 3,(IY+d)"].Execute = () => { };
        _opcodes["FD BIT 4,(IY+d)"].Execute = () => { };
        _opcodes["FD BIT 5,(IY+d)"].Execute = () => { };
        _opcodes["FD BIT 6,(IY+d)"].Execute = () => { };
        _opcodes["FD BIT 7,(IY+d)"].Execute = () => { };
        ...
        _opcodes["DD CP (IX+d)"].Execute = () => { };
        _opcodes["FD CP (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD JP (IX)"].Execute = () => { };
        _opcodes["FD JP (IY)"].Execute = () => { };
        ...
        _opcodes["DD LD (IX+d),B"].Execute = () => { };
        _opcodes["DD LD (IX+d),C"].Execute = () => { };
        _opcodes["DD LD (IX+d),D"].Execute = () => { };
        _opcodes["DD LD (IX+d),E"].Execute = () => { };
        _opcodes["DD LD (IX+d),H"].Execute = () => { };
        _opcodes["DD LD (IX+d),L"].Execute = () => { };
        _opcodes["DD LD (IX+d),A"].Execute = () => { };
        _opcodes["FD LD (IY+d),n"].Execute = () => { };
        _opcodes["FD LD (IY+d),B"].Execute = () => { };
        _opcodes["FD LD (IY+d),C"].Execute = () => { };
        _opcodes["FD LD (IY+d),D"].Execute = () => { };
        _opcodes["FD LD (IY+d),E"].Execute = () => { };
        _opcodes["FD LD (IY+d),H"].Execute = () => { };
        _opcodes["FD LD (IY+d),L"].Execute = () => { };
        _opcodes["FD LD (IY+d),A"].Execute = () => { };
        ...
        _opcodes["DD LD B,(IX+d)"].Execute = () => { };
        _opcodes["DD LD C,(IX+d)"].Execute = () => { };
        _opcodes["DD LD D,(IX+d)"].Execute = () => { };
        _opcodes["DD LD E,(IX+d)"].Execute = () => { };
        _opcodes["DD LD H,(IX+d)"].Execute = () => { };
        _opcodes["DD LD L,(IX+d)"].Execute = () => { };
        _opcodes["DD LD A,(IX+d)"].Execute = () => { };
        _opcodes["FD LD B,(IY+d)"].Execute = () => { };
        _opcodes["FD LD C,(IY+d)"].Execute = () => { };
        _opcodes["FD LD D,(IY+d)"].Execute = () => { };
        _opcodes["FD LD E,(IY+d)"].Execute = () => { };
        _opcodes["FD LD H,(IY+d)"].Execute = () => { };
        _opcodes["FD LD L,(IY+d)"].Execute = () => { };
        _opcodes["FD LD A,(IY+d)"].Execute = () => { };
        ...
        _opcodes["DD OR (IX+d)"].Execute = () => { };
        _opcodes["FD OR (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD RES 0,(IX+d)"].Execute = () => { };
        _opcodes["DD RES 1,(IX+d)"].Execute = () => { };
        _opcodes["DD RES 2,(IX+d)"].Execute = () => { };
        _opcodes["DD RES 3,(IX+d)"].Execute = () => { };
        _opcodes["DD RES 4,(IX+d)"].Execute = () => { };
        _opcodes["DD RES 5,(IX+d)"].Execute = () => { };
        _opcodes["DD RES 6,(IX+d)"].Execute = () => { };
        _opcodes["DD RES 7,(IX+d)"].Execute = () => { };
        _opcodes["FD RES 0,(IY+d)"].Execute = () => { };
        _opcodes["FD RES 1,(IY+d)"].Execute = () => { };
        _opcodes["FD RES 2,(IY+d)"].Execute = () => { };
        _opcodes["FD RES 3,(IY+d)"].Execute = () => { };
        _opcodes["FD RES 4,(IY+d)"].Execute = () => { };
        _opcodes["FD RES 5,(IY+d)"].Execute = () => { };
        _opcodes["FD RES 6,(IY+d)"].Execute = () => { };
        _opcodes["FD RES 7,(IY+d)"].Execute = () => { };
        ...
        _opcodes["DD RL (IX+d)"].Execute = () => { };
        _opcodes["FD RL (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD RLC (IX+d)"].Execute = () => { };
        _opcodes["FD RLC (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD RR (IX+d)"].Execute = () => { };
        _opcodes["FD RR (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD RRC (IX+d)"].Execute = () => { };
        _opcodes["FD RRC (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD SBC A,(IX+d)"].Execute = () => { };
        _opcodes["FD SBC A,(IY+d)"].Execute = () => { };
        ...
        _opcodes["ED SBC HL,BC"].Execute = () => { };
        _opcodes["ED SBC HL,DE"].Execute = () => { };
        _opcodes["ED SBC HL,HL"].Execute = () => { };
        _opcodes["ED SBC HL,SP"].Execute = () => { };
        ...
        _opcodes["DD SET 0,(IX+d)"].Execute = () => { };
        _opcodes["DD SET 1,(IX+d)"].Execute = () => { };
        _opcodes["DD SET 2,(IX+d)"].Execute = () => { };
        _opcodes["DD SET 3,(IX+d)"].Execute = () => { };
        _opcodes["DD SET 4,(IX+d)"].Execute = () => { };
        _opcodes["DD SET 5,(IX+d)"].Execute = () => { };
        _opcodes["DD SET 6,(IX+d)"].Execute = () => { };
        _opcodes["DD SET 7,(IX+d)"].Execute = () => { };
        _opcodes["FD SET 0,(IY+d)"].Execute = () => { };
        _opcodes["FD SET 1,(IY+d)"].Execute = () => { };
        _opcodes["FD SET 2,(IY+d)"].Execute = () => { };
        _opcodes["FD SET 3,(IY+d)"].Execute = () => { };
        _opcodes["FD SET 4,(IY+d)"].Execute = () => { };
        _opcodes["FD SET 5,(IY+d)"].Execute = () => { };
        _opcodes["FD SET 6,(IY+d)"].Execute = () => { };
        _opcodes["FD SET 7,(IY+d)"].Execute = () => { };
        ...
        _opcodes["DD SLA (IX+d)"].Execute = () => { };
        _opcodes["FD SLA (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD SRA (IX+d)"].Execute = () => { };
        _opcodes["FD SRA (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD SRL (IX+d)"].Execute = () => { };
        _opcodes["FD SRL (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD SUB (IX+d)"].Execute = () => { };
        _opcodes["FD SUB (IY+d)"].Execute = () => { };
        ...
        _opcodes["DD XOR (IX+d)"].Execute = () => { };
        _opcodes["FD XOR (IY+d)"].Execute = () => { };
